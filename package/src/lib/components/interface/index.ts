...
export function createRESTInterface<T,U=undefined>(input: Record<string,SingleOrMultipleRoutes>,routePrefiex: `/${string}` = '/api', createContext?: (event: RequestEvent) => U) {
	return {
